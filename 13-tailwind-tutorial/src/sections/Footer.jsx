      ...
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 font-montserrat text-white sm:max-w-sm">
            ...
            pariatur repudiandae fuga consequatur esse iure doloremque dicta
            minima assumenda modi.
          </p>
            ...
            <div key={section.title}>
              ...
              <ul>
                {section.links.map((item) => (
                  <li
                    key={item.name}
                    className="mt-3 font-montserrat text-base leading-normal text-white-400 cursor-pointer hover:text-slate-gray"
                  >
                    <a>{item.name}</a>
                  </li>
                ))}
